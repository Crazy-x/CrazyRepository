...
public class ExceptionController implements ErrorController {
    ...
    @Autowired
    private ExceptionInfoBuilder exceptionInfoBuilder;//错误信息的构建工具
    ...
    public ModelAndView errorHtml(HttpServletRequest request) {
        return new ModelAndView(DEFAULT_ERROR_VIEW, "errorInfo", exceptionInfoBuilder.getErrorInfo(request));
    }
    ...
    public ErrorInfo error(HttpServletRequest request) {
        return exceptionInfoBuilder.getErrorInfo(request);
    }
