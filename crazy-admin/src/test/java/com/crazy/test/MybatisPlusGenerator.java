...
public class MybatisPlusGenerator {
    ...
    private static final String BASE_PACKAGE = "com.crazy.coding";
...
//        strategy.setInclude(new String[] { "service_product" }); // 需要生成的表
        ...
        // 自定义 controller 父类
        strategy.setSuperControllerClass("RestApiController");
